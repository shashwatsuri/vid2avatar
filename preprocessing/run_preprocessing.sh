# pre-define data
source="custom"
seq="smpl_scan_continuous"
gender="MALE"

# run ROMP to get initial SMPL parameters
echo "Running ROMP"
romp --mode=video --calc_smpl --render_mesh -i=./raw_data/$seq/frames -o=./raw_data/$seq/ROMP --smpl_path ./romp/SMPL_NEUTRAL.pth
...
python normalize_cameras.py --input_cameras_file ../data/$seq/cameras.npz --output_cameras_file ../data/$seq/cameras_normalize.npz